...
public class LpTurnusFuzzyHV {
    ...
    public LpTurnusFuzzyHV createModel(List<Spoj2> possibleConnections, Map<Integer,Map<Integer, Triple<Long, Long, Long>>> dist, int pessimisticObjVal, int optimisticObjVal) {
